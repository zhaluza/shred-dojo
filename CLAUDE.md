...
- Covered: `scalePositions`, `wyldeScales`, `pentatonicTriads`, `scaleBuilder`, `chordVoicings`, `practiceLog` utils. `scalePositions` is verified against Pebber Brown's PDF in `resources/diatonic-scales/`.
